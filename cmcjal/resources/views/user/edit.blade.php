	...
	<section class="panel">
		<header class="panel-heading">
			<div class="panel-actions">
				...
				<h2 class="panel-title"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;Editar usuario</h2>
				...
				<div class="form-group">
					<div class="checkbox">
						<label for="status" class="col-sm-2 col-md-offset-2 control-label">
							<input type="checkbox" name="status" value="1" {{ $user->status == "1" ? 'checked' : '' }}> ¿Usuario activo?
						</label>
					</div>
				</div>

				{!! Form::submit('Guardar Cambios', ['class' => 'col-md-offset-1 btn btn-primary ', 'style' => 'margin-right: 15px; margin-top: 10px;']) !!}
